...
\echo '============================================================'
\echo '  1. Schedule & Calendar'
\echo '  2. Venue Management'
\echo '  3. Event Management'
\echo '  4. Participant Management'
\echo '  5. Registration Management'
...
SELECT register_participant(:'psic', :'pname', :'pemail', CAST(:'pyear' AS INTEGER));
\endif
\if :popt_is_2
SELECT * FROM view_participants();
\endif
\if :popt_is_3
\prompt 'Participant SIC: ' psic
\prompt 'New Name: ' pname
SELECT update_participant(:'psic', :'pname');
\endif
\if :popt_is_4
...
\if :popt_is_5
\prompt 'Participant SIC: ' psic
SELECT delete_participant(:'psic');
\endif
\endif
...
\prompt 'Event ID: ' eid
\prompt 'Participant SIC: ' psic
SELECT register_for_event(:'psic', CAST(:'eid' AS INTEGER));
\endif
\if :ropt_is_2
...
SELECT mark_attendance(:'psic', CAST(:'eid' AS INTEGER), :'rstatus');
\endif
\if :ropt_is_5
SELECT * FROM view_all_events();
\prompt 'Event ID: ' eid
SELECT * FROM view_registrations_by_event(CAST(:'eid' AS INTEGER));
\prompt 'Participant SIC: ' psic
SELECT cancel_registration(:'psic', CAST(:'eid' AS INTEGER));
\endif
\if :ropt_is_6
SELECT * FROM view_all_events();
\prompt 'Event ID: ' eid
...
SELECT * FROM view_registrations_by_event(CAST(:'eid' AS INTEGER));
\prompt 'Participant SIC: ' psic
SELECT create_performance(:'psic', CAST(:'eid' AS INTEGER));
\endif
\if :pfopt_is_2
...
\prompt 'Award ID: ' aid
\prompt 'Participant SIC: ' psic
SELECT assign_award_winner(CAST(:'aid' AS INTEGER), :'psic');
\endif
\if :aopt_is_4
\prompt 'Award ID: ' aid
